<link rel="stylesheet" type="text/css" href="<?php echo ASSETS; ?>styles/contact.css">
<link rel="stylesheet" type="text/css" href="<?php echo ASSETS; ?>styles/contact_responsive.css">

	<!-- Home -->

	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(<?php echo ASSETS; ?>images/contact.jpg)"></div>
						...
						<div class="col">
							<div class="home_content">
								<div class="breadcrumbs">
									<ul>
										<li><a href="<?php echo ASSETS; ?>">Home</a></li>
										<li>Contact</li>
									</ul>
								</div>
							</div>
